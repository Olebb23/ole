...
<i class="fa fa-dashboard" ></i> Dashboard / Legg Til Butikk
...
<i class="fa fa-money fa-fw"></i> Legg Til Butikk
...
<label class="col-md-3 control-label"> Butikk Navn : </label>
...
<label class="col-md-3 control-label"> Butikk Bilde : </label>
...
<label class="col-md-3 control-label"> Butikk Beskrivelse : </label>
...
<label class="col-md-3 control-label"> Butikk Knapp (f.eks "Se Kart") : </label>
...
<label class="col-md-3 control-label"> Butikk Url : </label>
